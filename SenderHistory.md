...
именовались в формате "Имя пользователя[Имя_компьютера]", причем оба имени<br>
брались из системных настроек Windows &mdash; т.е. совпадали с тем, что видно в<br>
"Сетевом окружении".</p>
<p>Двойным щелчком по имени пользователя в списке (или выбором в контекстном<br>
